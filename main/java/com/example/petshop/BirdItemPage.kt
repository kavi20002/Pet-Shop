...
import com.example.petshop.databinding.ActivityBirdItemPageBinding
import com.google.android.material.bottomnavigation.BottomNavigationView

class BirdItemPage : AppCompatActivity() {

    private lateinit var backBtn : ImageView
    private lateinit var cartBtn : Button
    private lateinit var favouriteBtn : ImageView
    private lateinit var binding: ActivityBirdItemPageBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBirdItemPageBinding.inflate(layoutInflater)
        ...
        if (intent != null){
            ...
            val desc = intent.getIntExtra("desc", R.string.bird1)
            val image = intent.getIntExtra("image", R.drawable.b1)

            binding.birdItemTitle.text = name
            binding.birdItemFee.text = price
            binding.birdDesc.setText(desc)
            binding.birdItemImage.setImageResource(image)
        }
